...
docker run -d --name postgres-container -e POSTGRES_USER=admin -e POSTGRES_PASSWORD=1 -e POSTGRES_DB=enivermont -p 7100:5432 -v postgres-data:/var/lib/postgresql/data postgres
